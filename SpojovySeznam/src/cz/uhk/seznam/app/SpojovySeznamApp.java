...
import cz.uhk.seznam.data.SpojovySeznam;
import fim.utils.Application;
import fim.utils.FIMReadException;

/**
 * Aplikace pouzivajici seznam implementovany pomoci spojoveho seznamu.
 * 
 * Pouzivame knihovnu FIMUTILS, ktera prostrednictvim nadtridy Application
 * nabizi menu, vystupni okno (out) apod. Knihovan je ve slozce libs projektu
 * 
 * @author Tomas Kozel
 *
 */
public class SpojovySeznamApp extends Application {

	//jedine misto, kde se oba priklady lisi
	private Seznam s = new SpojovySeznam();
